  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-[2rem] blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
        ...
        <div className="relative flex items-center gap-4 bg-black/90 dark:bg-slate-900/90 backdrop-blur-xl border border-white/10 px-6 py-4 rounded-[2rem] shadow-2xl">
          {/* Binance Icon Custom SVG */}
          <div className="relative w-10 h-10 flex items-center justify-center bg-yellow-400 rounded-full shadow-[0_0_20px_rgba(250,204,21,0.4)] transition-transform group-hover:rotate-[360deg] duration-700">
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-black" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.624 13.9202l-4.624 4.624-4.624-4.624 4.624-4.624 4.624 4.624zm4.624-4.624l-1.928 1.928-2.696-2.696 4.624-4.624 4.624 4.624-4.624 4.624zm-13.872 0l-4.624-4.624 4.624-4.624 4.624 4.624-2.696 2.696-1.928-1.928zm4.624-4.624l4.624 4.624-4.624 4.624-4.624-4.624 4.624-4.624zm0 18.512l-4.624-4.624 4.624-4.624 4.624 4.624-4.624 4.624z" />
            </svg>
          </div>
          ...
          <div className="fixed inset-0 z-[999] flex items-center justify-center px-4">
            ...
            >
              ...
              <div className="text-center">
                <h4 className="text-2xl font-black text-white uppercase italic mb-6">Binance <span className="text-yellow-400">Merchant</span></h4>
